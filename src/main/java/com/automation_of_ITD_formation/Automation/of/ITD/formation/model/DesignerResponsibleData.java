...
@Entity
public class DesignerResponsibleData {
    ...
    @OneToMany(mappedBy = "designerResponsibleData", cascade = CascadeType.ALL)
    ...
    public DesignerResponsibleData() {
    }

    public DesignerResponsibleData(String position, String name, String idNumber, String nameDocument, String numberDocument, String dateDocument, String nameCompany, String ogrnCompany, String innCompany, String adrCompany) {
        this.position = position;
        this.name = name;
        this.idNumber = idNumber;
        this.nameDocument = nameDocument;
