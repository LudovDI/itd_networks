...
@Entity
public class CustomerResponsibleData {
    ...
    @OneToMany(mappedBy = "customerResponsibleData", cascade = CascadeType.ALL)
    ...
    public CustomerResponsibleData() {
    }

    public CustomerResponsibleData(String position, String name, String idNumber, String nameDocument, String numberDocument, String dateDocument, String nameCompany, String ogrnCompany, String innCompany, String adrCompany) {
        this.position = position;
        this.name = name;
        this.idNumber = idNumber;
        this.nameDocument = nameDocument;
