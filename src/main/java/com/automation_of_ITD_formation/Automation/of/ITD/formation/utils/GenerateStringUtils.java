...
public class GenerateStringUtils {
    public static String generateCapitalConstructionProject(PassportObjectData passportObjectData) {
        return passportObjectData.getNameObject() + " " +
                passportObjectData.getNameDeveloper() + ", ОГРН " +
                passportObjectData.getOgrnDeveloper() + ", ИНН " +
                passportObjectData.getInnDeveloper() + ", " +
                passportObjectData.getAddressDeveloper();
    }

    public static String generateDeveloper(PassportObjectData passportObjectData) {
        return passportObjectData.getNameDeveloper() + ", ОГРН " +
                passportObjectData.getOgrnDeveloper() + ", ИНН " +
                passportObjectData.getInnDeveloper() + ", " +
                passportObjectData.getAddressDeveloper() + ", телефон/факс: " +
                passportObjectData.getPhoneDeveloper() + "; " +
                passportObjectData.getNameOrganizationDeveloper() + ", ОГРН " +
                passportObjectData.getOgrnOrganizationDeveloper() + ", ИНН " +
                passportObjectData.getInnOrganizationDeveloper();
    }

    public static String generateBuilder(PassportObjectData passportObjectData) {
        return passportObjectData.getNameBuilder() + ", ОГРН " +
                passportObjectData.getOgrnBuilder() + ", ИНН " +
                passportObjectData.getInnBuilder() + ", " +
                passportObjectData.getAddressBuilder() + ", телефон/факс: " +
                passportObjectData.getPhoneBuilder() + "; " +
                passportObjectData.getNameOrganizationBuilder() + ", ОГРН " +
                passportObjectData.getOgrnOrganizationBuilder() + ", ИНН " +
                passportObjectData.getInnOrganizationBuilder();
    }

    public static String generatePreparer(PassportObjectData passportObjectData) {
        return passportObjectData.getNamePreparer() + ", ОГРН " +
                passportObjectData.getOgrnPreparer() + ", ИНН " +
                passportObjectData.getInnPreparer() + ", " +
                passportObjectData.getAddressPreparer() + ", телефон/факс: " +
                passportObjectData.getPhonePreparer() + "; " +
                passportObjectData.getNameOrganizationPreparer() + ", ОГРН " +
                passportObjectData.getOgrnOrganizationPreparer() + ", ИНН " +
                passportObjectData.getInnOrganizationPreparer();
    }
    ...
    public static String generateNameOrganization(PassportObjectData passportObjectData) {
        return passportObjectData.getNameBuilder();
    }
