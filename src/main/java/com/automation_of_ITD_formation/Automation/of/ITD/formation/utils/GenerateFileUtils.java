...
public class GenerateFileUtils {
    ...
    public static File generateExcavationLogFile(Map<String, Integer> monthMap, String namePerformanceManager, List<AosrData> aosrToLogList) throws IOException {
        ...
        String nameCustomer = passObj.getNameDeveloper();
        replacePlaceholder(document, "NameCustomer", nameCustomer);
        String nameBuilder = passObj.getNameBuilder();
    ...
    public static File generateGeneralLogDocxFile(PassportObjectData passObj) throws IOException {
        ...
        String nameOrganization = passObj.getNameBuilder();
    ...
    public static File generateRegistryFile(PassportObjectData passObj, List<AosrData> aosrDataList, List<AosrData> aosrToExcavLogList) throws IOException {
        ...
        setTextInCell(excelDocument, "РЕЕСТР - папка №1", 1, 1, passObj.getNameDeveloper());
        setTextInCell(excelDocument, "РЕЕСТР - папка №1", 2, 1, passObj.getNameDeveloper());
        setTextInCell(excelDocument, "РЕЕСТР - папка №1", 3, 1, passObj.getNameBuilder());
        ...
        for (AosrData aosrData : aosrDataList) {
            ...
            values.add(List.of(Integer.toString(index), str1, str2, aosrData.getEndDate().format(formatter), passObj.getNameBuilder(), "1"));
            index++;
            ...
            values.add(List.of(Integer.toString(index), str3, str4, aosrData.getEndDate().format(formatter), passObj.getNameBuilder(), "1"));
            index++;
            ...
            if (aosrData.getProtocolsGnbData() != null) {
                ...
                values.add(List.of(Integer.toString(index), "Протокол работ по бурению", protocolsGnbData.getNumberProtocolGnb(),
                        protocolsGnbData.getDataProtocolGnb(), aosrData.getPassportObjectData().getNameBuilder(), "1"));
                index++;
            }
