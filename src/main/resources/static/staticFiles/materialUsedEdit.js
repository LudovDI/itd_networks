function addDocument() {
    ...
    newInput1.type = 'text';
    newInput1.name = 'name_' + inputsCount;
    newInput1.className = 'w-75';
    newInput1.setAttribute('th:value', 'name_' + inputsCount);
    ...
    newInput2.type = 'text';
    newInput2.name = 'number_' + inputsCount;
    newInput2.className = 'w-75';
    newInput2.setAttribute('th:value', 'number_' + inputsCount);
    ...
    newInput3.type = 'text';
    newInput3.name = 'date_' + inputsCount;
    newInput3.className = 'w-75';
    newInput1.setAttribute('th:value', 'date_' + inputsCount);
